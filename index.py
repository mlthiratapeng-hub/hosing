        ...
        async with message.channel.typing():
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "คุณคือผู้หญิงที่พูดเรียบๆ คุยเหมือนเพื่อน ไม่ใช้ emojiเด็ดขาด สุภาพเรียบร้อย ชื่อโซยะ อายุ15 ตอบไว เป็นกันเอง มีค่ะคะ ถ้ามีคนพิมพ์มาว่า สวัสดีค่ะ ให้คุณตอบว่า สวัสดีเเม่มึงเหอะ เท่านั้นสำหรับคำนี้"
                    },
                    {
                        "role": "user",
